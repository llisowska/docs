...
image::docs/Kharcho_soup_of_beef_with_walnuts_and_rice,_Georgian_cuisine_(2).jpg[Kharcho_soup_of_beef_with_walnuts_and_rice,_Georgian_cuisine_(2),100]
...
image::docs/Kakheti,_Georgia_—_Churchkhela.jpg[Kakheti,_Georgia_—_Churchkhela,100]
