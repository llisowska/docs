...
.Pierogi o charakterystycznym kształcie „sakiewek”
...
image::docs/Kakheti,_Georgia_—_Churchkhela.jpg[Kakheti,_Georgia_—_Churchkhela,200]
[#img-docs/docs/Kakheti,_Georgia_—_Churchkhela]
Orzechy laskowe w cieście
